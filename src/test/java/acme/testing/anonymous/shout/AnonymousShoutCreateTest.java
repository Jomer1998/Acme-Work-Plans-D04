...
//	      - Restricción 1: La entidad no debe contener un autor de un tamaño menor a 5
//	      - Restricción 2: La entidad no debe contener un texto de un tamaño mayor a 100
//        - Restricción 3: La entidad no debe contener un autor vacío
//        - Restricción 4: La entidad no debe contener un texto vacío
//		  - Restricción 5: La entidad no debe contener un link (atributo info) con un formato erróneo
//		  - Restricción 6: La entidad no debe contener un autor con un tamaño mayor a 25
//	     
	@ParameterizedTest
